...
public class Question1Fragment extends Fragment implements OnDataPass{
    ...
    public void onProfileDataPass() {
        EditText et = view.findViewById(R.id.tbName);
        Profile.AddData("name", et.getText().toString());
    }
}
